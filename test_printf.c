...
/*   Updated: 2024/10/22 21:43:05 by cw3l             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int decimal_d_test()
{
	int a = printf("%dccc",INT_MAX);
	print_int(a);
	int b = ft_printf("%dccc",INT_MAX);
	print_int(b);
	assert(a == b);
	int c = printf("%dccc",INT_MIN);
	print_int(c);
	int d = ft_printf("%dccc",INT_MIN);
	print_int(d);
	assert(c == d);
	return (1);
}
...
int hex_test()
{
	...
	int a = printf("%x", INT_MAX);
	print_int(a);
	int b = ft_printf("%x", INT_MAX);
	assert(a== b);
